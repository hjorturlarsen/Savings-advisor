...
class Tab1(wx.Panel):
    def __init__(self, parent):
        ...
        vbox3.AddMany([ (wx.StaticText(pnl1, -1, u'Nafn:'),0, wx.ALIGN_CENTER| wx.TOP, 45),
        ...
        #vbox4.Add(wx.StaticText(pnl2, -1, u'Upphæð:'),0)
        #vbox4.Add(self.tc6)
        #vbox4.Add(wx.StaticText(pnl2, -1, u'Tími:'),0)
        #vbox4.Add(self.tc7)
        #vbox4.Add(wx.Button(pnl2, 13, u'Finna'),   0, wx.ALIGN_CENTER| wx.TOP, 45)
